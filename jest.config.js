...
module.exports = {
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        '!<rootDir>/**/*.e2e.ts',
        '<rootDir>/packages/*/src/**/__tests__/*.jsdom.{ts,tsx}',
        '<rootDir>/apps/*/src/**/__tests__/*.jsdom.{ts,tsx}',
        '<rootDir>/scripts/**/__tests__/*.jsdom.{ts,tsx}',
        '<rootDir>/scripts/__tests__/*.jsdom.{ts,tsx}',
      ],
      transformIgnorePatterns: ['/node_modules/'],
    },
